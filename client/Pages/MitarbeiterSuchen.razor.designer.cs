...
namespace SinDarElaMobile.Pages
{
    public partial class MitarbeiterSuchenComponent : ComponentBase, IDisposable
    {
        ...
        IEnumerable<SinDarElaMobile.Models.DbSinDarEla.VwMitarbeiterSuchen> _rstMitarbeiter;
        protected IEnumerable<SinDarElaMobile.Models.DbSinDarEla.VwMitarbeiterSuchen> rstMitarbeiter
        {
            get
            {
